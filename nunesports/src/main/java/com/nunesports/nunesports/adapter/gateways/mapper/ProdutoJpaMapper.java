...
public class ProdutoJpaMapper {
    ...
    public ProdutoJpaMapper() {}

    public ProdutoJpaMapper(UUID id, String nome, String codigo, String descricao, double preco) {
        this.id = id;
        this.nome = nome;
        this.codigo = codigo;
    ...
    public boolean equals(Object o) {
        ...
        ProdutoJpaMapper that = (ProdutoJpaMapper) o;
